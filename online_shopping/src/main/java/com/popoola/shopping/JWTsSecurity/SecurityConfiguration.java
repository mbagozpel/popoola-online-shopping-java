...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
            ...
            http.cors().and().csrf().disable().authorizeRequests()
                    ...
                    .antMatchers("/order/finish/**").access("hasAnyAuthority('STAFF','CEO')")
                    .antMatchers("/category/add-category").access("hasAnyAuthority('STAFF','CEO')")
                    .antMatchers("/order/**").authenticated()
                    .antMatchers("/product/add-product/**").access("hasAnyAuthority('STAFF','CEO')")
                    .antMatchers("/product/**").access("hasAnyAuthority('STAFF','CEO')")
